...
**To look up your destination country requirements:** Visit the [USDA APHIS Pet Travel website](https://www.aphis.usda.gov/pet-travel/us-to-another-country-export) and search for your destination country in step 2\. This is also where you’ll determine if your destination is a Green Banner or Orange Banner country.
...
### **2\. Not Getting CURV Before Leaving OR Letting US Rabies Vaccination Expire (Dogs from High-Risk Countries Only)**

**❌ THE MOST EXPENSIVE MISTAKE**

If you’re traveling to a [**high-risk rabies country**](https://www.cdc.gov/importation/dogs/high-risk-countries.html) and planning to return to the US, you **MUST**:

1. Get a CURV (Certification of US-Issued Rabies Vaccination) **BEFORE** you leave

2. Ensure your dog’s US rabies vaccination does **NOT expire** while abroad

**If either of these fails, your dog becomes “foreign-vaccinated”** and must follow the complex re-entry process.

#### *Without CURV or with Expired US Rabies Vaccine:*
...
#### *With Valid CURV and Current US Rabies Vaccine:*

* ✅ Easy re-entry at any US port

* ✅ No facility required

* ✅ Cost: **$435** (for initial CURV)
...
### **3\. Starting Too Late OR Missing Critical Waiting Periods**

**Timeline matters\!** Some destinations require **6+ months** of preparation, and missing critical waiting periods can delay your travel.

#### *Complex Destinations (6+ months needed):*

* **Australia, New Zealand, Japan**

  * Requirements: Rabies titer testing, waiting periods, import permits, etc.
...
### **4\. Not Checking Airline Requirements**
...
**Getting Started:** We’ll send you a form to complete with your pet’s travel plans and health history. Once submitted with the research fee, we can begin researching requirements and building your travel timeline.

**IMPORTANT:** We cannot proceed or give accurate guidance without complete information, including proper rabies vaccine certificates from ALL prior veterinary hospitals. Research incurs a **non-refundable fee**, even if your pet is ultimately unable to travel in your timeline.
...
### **Common Requirements & Country-Specific Timelines**

**Important:** Some countries have requirements that can take significantly longer. Check destination country requirements early and plan well in advance. The requirements below are common to most destinations, with specific timeline requirements noted.

#### *Microchip (if required by country and not already present)*
...
#### *Our IHC Appointment Process & Costs:*
...
* Microchip number (only if microchip was implanted before that rabies vaccine was given)

* ⚠️ **CRITICAL:** All pet information MUST match exactly on each rabies certificate and with the pet’s medical record, or it likely will not be endorsed by the USDA

### **Vaccine Details:**

* Manufacturer name

* Manufacturer vaccine type (note: “Killed” as a type is not accepted)

* Vaccination date

* Vaccination expiration/due date
...
* Clinic/Hospital contact information and address
...
* **VEHCS Document Viewer:** [https://vehcs.aphis.usda.gov/vehcs/faces/ext\_cert\_viewer.jsf](https://vehcs.aphis.usda.gov/vehcs/faces/ext_cert_viewer.jsf)

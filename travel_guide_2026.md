...
This comprehensive guide is designed for pet owners planning to travel internationally with their dogs or cats. Whether you're:

- **Taking your pet abroad** (exporting from the US)
- **Bringing your pet back home** (importing to the US)
- **Planning a round-trip journey** with your pet
- **Moving permanently** to another country

Our hospital has USDA-accredited veterinarians who specialize in preparing dogs and cats for international travel. We're here to help make this process as smooth as possible for you and your pet!

---

## How to Use This Guide

**For Website Users:** This guide is organized into collapsible sections. Click on any section header to expand and view detailed information. Only open the sections relevant to your travel needs.
...
### [IHC (International Health Certificate)](https://www.aphis.usda.gov/pet-travel)
Also called an export health certificate. This is the official document required by most countries to allow your pet to enter. It includes exam findings, vaccination records, and treatments.
...
Official review and stamp by the US Department of Agriculture on health certificates and CURV forms. Most countries require this. Documents are submitted electronically through VEHCS.

### [VEHCS (Veterinary Export Health Certification System)](https://vehcs.aphis.usda.gov/)
USDA's online system where accredited veterinarians submit and track health certificates and CURV forms for endorsement.
...
The **first** rabies vaccination given to a dog, OR the first vaccination after any lapse in coverage (even one day when rabies vaccination expired before the next booster). Valid for **only 1 year**, even if the vaccine label says 3 years. Some countries require waiting periods after primary vaccination before travel.
...
Many certificates are missing critical information required for USDA endorsement. Even if your vet gave you a rabies certificate, it might not include everything needed for international travel.
...
- Clinic contact information and address
...
**Timeline matters!** Some destinations require **6+ months** of preparation.
...
- Plan accordingly if your pet needs a primary vaccine

#### General Timeline:
- Start **2-6+ months** before departure depending on destination
- Allow time for: research, consultations, vaccinations, waiting periods, testing, documentation

---

### 4. Missing Critical Waiting Periods

**For Dogs:**
- **28-day wait** after primary rabies vaccination before CURV can be submitted
- **21-day wait** after primary rabies vaccination for EU/UK travel
- **30-90 days** for rabies titer results (some countries)

---

### 5. Letting US Rabies Vaccination Expire Abroad (Dogs)

If your dog's US rabies vaccination **expires while you're abroad**, your dog becomes "foreign-vaccinated" and must follow the complex, expensive re-entry process (Section 3C: **$2,000-$7,000+**).

**Solution:** Get a **3-year rabies booster** before extended travel so your CURV stays valid longer.

---

### 6. Not Checking Airline Requirements

Airlines often have requirements that are **MORE STRICT** than destination countries. It's **your responsibility** to verify and inform us of any additional requirements.
...
### 7. Booking Travel Before Meeting All Requirements
...
Some countries have requirements that can take significantly longer. Check destination country requirements early and plan well in advance.

#### Complex Destinations (6+ months):
- **Australia, New Zealand, Japan:** Multiple blood tests including rabies titer testing, waiting periods, import permits

#### EU/UK (minimum 21 days):
- Minimum 21-day wait after primary rabies vaccination

#### Countries with Rabies Titer Requirements:
- **Examples:** Australia, New Zealand, Japan, South Korea, China, Hawaii

---

### Step 1: Research & Consult with Our Hospital

**Before booking a consult, we will need to do some research, which incurs a non-refundable fee, even if your pet is ultimately unable to travel in the timeline you need.**
...
#### Research Fee:
- **$100** for new clients/patients who are new to our hospital
- **$50** for existing pets
...
- Review USDA APHIS export requirements
- Review CDC re-entry requirements (if applicable)
- Determine if destination is low- or high-risk for rabies
- Gather and assess your pet's complete medical and rabies history
- Identify lapses or incomplete vaccine documentation
- Begin building your pet's personalized timeline along with any additional requirements needed for your pet
- We research and reach back out ASAP with information (same day to a few days depending on available information, travel timeline, and available prior vet records)

**We cannot give accurate guidance until we have complete records.**

---

### Step 2: Required International Travel Consultation & Exam

**An in-person consult is required before IHC appointment (unless timeline doesn't allow - see urgent fee below)**

- **Scheduled:** 2-3 months before departure when possible
- **Cost:** $95 (for both dogs and cats)

#### During this consultation, we will:
- Perform complete physical exam
- If present, scan your pet's microchip to ensure it is present and functioning
- Confirm ISO microchip compliance if required
- Review prior rabies documentation and timing
- Identify any vaccine gaps or lapses; update vaccines if appropriate
- Schedule and/or perform required testing or treatment (if needed)
- Review airline policy (general vs specific airline requirements & restrictions)
- Outline all steps needed for your destination for USDA endorsement and further discuss timeline of international health certificate exam/appointment
- Discuss travel tips, managing travel anxiety, and anxiety medication options if appropriate
  - **Note:** Airlines won't fly pets appearing sedated in cargo for safety - we carefully evaluate each case
- Answer all questions you may have

#### If timeline doesn't allow for separate consultation:
- All destination country requirements must be met in advance before the IHC visit
...
### Common Requirements Information

#### Microchip:
- **Cost:** Placement $89, registration $20
- ISO-compliant/universal scanner required if destination requires it
...
#### What's a "Primary" Vaccination?
Valid **1 year only**, even if vaccine says 3 years. This includes:
...
**Some destinations (such as any European country) require a "primary rabies vaccine" and 21-day wait.**

#### Additional Vaccines (if required by destination):

These vaccines are also generally recommended even if not required and are based on individual pet's lifestyle/exposure:
...
#### Rabies Titer Blood Draw (if required):
- May be done at consult if appropriate at that time (will be discussed) or scheduled later if rabies vaccination needs to occur first
...
- **Timeline:** Takes 3-8 weeks depending on lab workload
...
|----------|------------|---------|
| **International Health Certificate (IHC)** | Vet exam + health statement | To ENTER foreign country |
| **Certification of US-Issued Rabies Vaccination (CURV)** | DOG only: US rabies vaccination certificate | To RETURN your dog to US from high-risk country |

**NOTE:** Your DOG may need BOTH for a round trip.

#### Do I need a CURV?

Check if your destination is [high-risk](https://www.cdc.gov/importation/dogs/high-risk-countries.html):
...
2. Complete CURV in VEHCS system once you have submitted the required travel information to us
3. Submit to USDA for endorsement (can take days for endorsement, rarely weeks)
...
**Cost:** $435 (CURV Submission is $310, USDA endorsement is $125)

**Timeline:** Allow 2-4 weeks before departure; 28-day wait if primary vaccination

**Pro Tip:** For extended travel, get 3-year rabies booster if appropriate so CURV stays valid longer

---

### Step 4: International Health Certificate (IHC) Appointment
**Applies to both dogs and cats**

**Schedule:** Within 10 days of departure (most countries) or per destination country requirement (some may be more or less). We will verify your destination's specific timing.
...
**If this form is not completed 48 hours before your appointment, your appointment may be canceled.**

#### Our IHC Appointment Process:

**Costs (same for dogs and cats):**
- Health certificate base fee: $310
- Physical exam and microchip scan/verification: $95
- USDA endorsement (most common): $125 (single certificate to verify vaccines only)
- USDA endorsement with vaccines and testing verification: $175-230 (such as rabies titer)
- Urgent Health Certificate Fee (if applicable): $100
- Shipping overnight if physical IHC needed (APHIS orange banner countries): $75
- Internal/external parasite treatment (if required): $30-150 per pet (varies based on size and country requirements)

#### Deposit & Rescheduling Policy:
- **Deposit required when booking:** $150 which will be applied toward your IHC visit
- **Rescheduling with >48 hr notice:** Additional $75 deposit required
- **Rescheduling <48 hours' notice or no-show:** Deposit is non-refundable; new full fee applies for rescheduled appointment

#### At the IHC Visit:
1. Perform complete physical exam and microchip scan/verification
2. Verify all vaccinations and treatments are current
3. Administer internal and external parasite treatment (if required by destination)
4. Complete appropriate health certificate for your destination country
5. Give any additional treatments/test to pet if indicated
6. Answer any final questions not yet addressed
7. **If USDA endorsement required:** Submit to USDA via VEHCS for endorsement, then email you the endorsed document (green banner countries - digital) or discuss facilitation of shipping endorsed IHC (orange banner countries - physical with embossed seal shipped overnight)
8. **If USDA endorsement not required:** Issue health certificate at this visit
...
## Section 3: Importing Dogs to the US
...
- Takes 5 minutes, **no fee (free)**, for dogs only
- Receipt emailed immediately (show on phone or print)
- Valid 6 months for multiple entries from same country
...
- **Rabies vaccination is not required by CDC** (but recommended and often required by airlines and most US states)
  - [Check state requirements here](https://www.aphis.usda.gov/pet-travel/state-to-state)
- **USDA screwworm certification required if from affected country**
...
- **Hawaii/Guam:** Special quarantine requirements even from US mainland
...
| Dog Rabies Vaccine (1 or 3yr) | $45 | |
| Cat Rabies Vaccine (1yr) | $55 | Purevax - non-adjuvanted |
| Cat Rabies Vaccine (3yr) | $98 | Purevax - non-adjuvanted |
| Other Vaccines (DHPP, FVRCP, etc.) | $45-60 | Per vaccine (if required) |
| **TESTING (IF NEEDED)** | | |
| Rabies Titer Test (RNATT/FAVN) | $370 | Includes overnight shipping to lab |
| Other Testing | Varies | For specific countries (ie Australia & New Zealand) |
| **CURV (IF NEEDED)** | | |
| Certification of US Issued Rabies Vaccination (CURV) | $435 | DOGS ONLY: For return to US from high-risk country |
| **HEALTH CERTIFICATE** | | |
| Physical Exam & Microchip Scan | $95 | At IHC appointment, per pet traveling |
| International Health Certificate (IHC) - USDA endorsement needed | $310 | Per pet traveling |
| IHC - no USDA endorsement needed | $110 | Per pet traveling |
| Urgent Processing Fee (If applicable) | $100 | Required if consult not performed prior to IHC |
| USDA Endorsement (single certificate) | $125 | Per certificate - 2+ pets can usually be on one |
| USDA Endorsement with Testing Certifications | $175-230 | If rabies titer or multiple tests need verification |
| Internal & External Parasite Treatment Per Pet (If needed) | $30-150 | Varies by size, type of pet, and country requirements |
| Deposit at IHC Booking | $150 | Required to schedule; goes towards cost of IHC visit |
| Rescheduling >48 hours notice | $75 | Goes towards re-booked IHC appointment |
| Rescheduling <48 hours or No-Show | Non-refundable | New full fee for rescheduled appointment |
| **Overnight Shipping (Orange Banner Countries)** | $75 | Required for EU, UK, and other orange banner countries |
| **COMPLEX DESTINATIONS** | | |
| Australia, New Zealand, Japan Additional Fee | $165 | Additional fee on top of regular fees per pet |
| Australia ID per USDA submission | $125 | ID 1, ID 2, and Final ID required. Per pet per submission (3 total). Does not include $65 progress exam fee for ID 2 |
...
- Complex Destination Fee: $165
- Additional testing, treatment, progress exams: $500-1,000+

*For Australia specifically:*
- Australia ID Endorsements (3 required): ~$440
...
- **State-to-State Requirements:** [https://www.aphis.usda.gov/pet-travel/take-pet-to-another-state](https://www.aphis.usda.gov/pet-travel/take-pet-to-another-state)
- **VEHCS Document Viewer:** [https://vehcs.aphis.usda.gov/vehcs/faces/ext_cert_viewer.jsf](https://vehcs.aphis.usda.gov/vehcs/faces/ext_cert_viewer.jsf)

### Community Support:
- **Facebook Group:** U.S. CDC Dog Import Help (Lisa Carter) - Community support and real experiences

---

## Contact Bluebonnet Animal Hospital

**We look forward to helping you and your pet travel safely!** Our team of USDA-accredited veterinarians is here to guide you through every step of the international travel process.

**Start early, complete all required forms, and don't hesitate to contact us with questions.**

**Bluebonnet Animal Hospital**  
Website: [https://bluebonnetah.com/](https://bluebonnetah.com/)

For international travel inquiries, please contact our hospital directly to begin your pet's travel journey!

---

**Document Version:** January 2026  
**Based on:** CDC regulations effective August 1, 2024

**Disclaimer:** This guide is informational. Always verify current requirements with official sources (CDC, USDA, destination authorities) as regulations change. Our hospital can help you navigate these requirements through our research consultation and travel services.
